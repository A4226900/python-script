...
ax.set_extent([120, 131, 16, 25], crs=ccrs.PlateCarree())
...
# 台湾位置
plt.scatter(taiwan_pos[1], taiwan_pos[0], color='black', label="起始点(台湾东部)", transform=ccrs.PlateCarree())
